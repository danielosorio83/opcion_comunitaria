    ...
    return (
      <Fragment>
        <main className="inner cover" role="main">
          ...
          <p className="lead">
            <a class="btn btn-lg btn-secondary" href="http://compaz.opcioncomunitaria.org/managers/sign_in">Ir a ComPAZ</a>
            <a class="btn btn-lg btn-secondary" href="http://compaz-staging.opcioncomunitaria.org/managers/sign_in">Zona de Pruebas</a>
          </p>
        </main>
